    ...
    function EfforTracker(props, state) {
        ...
        _this.datalayer.processFetchedData(_this.props.effortlist, _this.props.filerelativePath).then(function (val) {
            if (val) {
                ...
                tempViewFields_1.push({ name: "Total Efforts", displayName: "Total Efforts", minWidth: 150 });
                var chartDataObject = _this.datalayer.getChartDataSetData(_this.props.offshore, _this.props.onsite);
        ...
        return (React.createElement("div", { className: styles.efforTracker },
            React.createElement("div", { className: styles.container },
                React.createElement("div", { className: styles.row },
                    React.createElement("div", { className: styles.column }, _.isEmpty(this.state.effortChartData) ?
                        null : React.createElement(ChartControl, { type: ChartType.Bar, data: this.state.effortChartData, options: options })),
                    React.createElement("div", { className: styles.column }, _.isEmpty(this.state.monthlyEffortdata) ?
                        ...
                        this.state.items.map(function (itemval, itemindex) {
                            return (React.createElement("tr", null, Object.keys(itemval).map(function (objval) {
                                return (objval === "ResourceEMail" ||
                                    ...
                                    objval === "w3a" || objval === "w4a" || objval === "w5a" ? "" : React.createElement("td", null, itemval[objval]));
                            })));
                        }))))));
    };
    return EfforTracker;
