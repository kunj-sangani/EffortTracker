...
var DataLayer = /** @class */ (function () {
    ...
    DataLayer.prototype.getChartDataSetData = function () {
        var _this = this;
        ...
        this.holidayData.map(function (valholiday, indexholiday) {
            if (indexholiday !== 0) {
                ...
                var employeeStrengthBasedOnLocation_1 = employeeBasedOnLocation_1.length;
                Object.keys(_this.weekDaysMapping).map(function (val, index) {
                    var weekAvailableEffort = (parseInt(_this.weekDaysMapping[val], 10) - parseInt(valholiday[index + 1], 10)) * 8 * employeeStrengthBasedOnLocation_1;
